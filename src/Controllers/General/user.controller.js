...
export const createUser = async (req, res) => {
  ...
  if (!savedUser) {
    return res
      .status(500)
      .json({ message: "Error while creating the user. Try again" });
  }
...
export const getUsers = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while getting the users. Try again" });
  }
};
...
export const updateUserById = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while updating the user. Try again" });
  }
};
...
export const updateUserPartiallyById = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while  partially updating the user. Try again" });
  }
};
...
export const deleteUserById = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error while deleting the user. Try again" });
  }
};
